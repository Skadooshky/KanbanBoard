...
public class AddCardDialog extends JDialog {
    ...
    public AddCardDialog(Window owner) {
        super(owner, "Add Card", ModalityType.APPLICATION_MODAL);
        ...
        // sensible defaults
        cboStatus.setSelectedItem(KanbanStatus.TO_DO);
        txtDueDate.setText(LocalDate.now().plusDays(7).format(DATE_ONLY));
    ...
    private void onSave() {
        ...
        // Due date must be in SQLite expected format
